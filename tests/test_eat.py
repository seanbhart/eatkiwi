...
def test_notification():
    ...
    mentioned_user = ApiUser(
        fid=13468,
        username='fcdevtest01',
        display_name='dev test account 01',
        registered_at=None,
        pfp=ApiPfp(url='https://i.imgur.com/yMvaI8i.jpg', verified=False),
        profile=ApiProfile(bio=Bio(text='', mentions=[])),
        follower_count=11,
        following_count=0,
        referrer_username=None,
    ...
    text = '\n'.join([
        "@fcdevtest01 eat in the style of ",
        # "Hacker News",
        ...
        " https://www.theblock.co/post/232754/multichain-team-says-it-cant-contact-ceo-amid-protocol-problems",
    ])
...
def test_eat_notification(eat_instance, test_notification):
    set_config()

    # Call the eat_notification function with the test notification
    eat_instance.eat_notification(test_notification)
